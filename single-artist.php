...
echo '<div class="column">
                    ...
                    <div class="ui fluid card">
                        ...
                        <div class="image"> <a href="single-painting.php?id=' . $paintings[0]['PaintingID'] . '"><img class="ui big image" id="artwork" src="images/art/works/square-medium/' . $paintings[0]['ImageFileName'] . '.jpg"></a> </div>
